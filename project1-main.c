...
imatrix* init_rgb(imatrix* this, int width, int height, int channels){
    ...
    //this = (uint8_t*) malloc(sizeof(uint8_t) * width * height * channels);
    //this->r = malloc(sizeof(uint8_t)*(width));
    //this->g = malloc(sizeof(uint8_t)*(width));
    //this->b = malloc(sizeof(uint8_t)*(width));

    // this->r = calloc((width*height),sizeof(uint8_t));
    // this->g = calloc((width*height),sizeof(uint8_t));
    // this->b = calloc((width*height),sizeof(uint8_t));
